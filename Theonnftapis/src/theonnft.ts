...
export function handleItemBought(event: ItemBought): void {
  ...
  //
  // - contract.getAllListedItems(...)
  // - contract.getListingPrice(...)
  // - contract.getOwnerListedItems(...)
  // - contract.getPerticularItem(...)
  // - contract.getSellerListedItems(...)
  // - contract.listings(...)
}

export function handleItemList(event: ItemList): void {}
