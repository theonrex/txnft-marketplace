...
function About() {
  return (
    <div className="forth-section ">
      <div className="container " id="Investor" data-aos="zoom-in">
        <header>
          {" "}
          home to world&apos;s <br />
        ...
        <div className="rowX investor">
          ...
          <div className="col23">
            {" "}
            <img
              src="https://equitek.ca/wp-content/uploads/2019/03/Oracle-Logo.png"
              alt="image"
            />
          </div>
          <div className="col23">
            ...
            <img
              src="https://images.squarespace-cdn.com/content/v1/58f293d7cd0f68deb2586954/1493950179262-J84QH1KM4UMECY7TU3LX/Verifone-logo-2014.png"
              alt="image"
            />
          </div>
          <div className="col23">
            {" "}
            <img
              src="https://iconape.com/wp-content/files/bj/51619/svg/coinbase.svg"
              alt="image"
            />
          </div>
        </div>
